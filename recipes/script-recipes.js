...
const displayRecipe = (recipe) => {
    document.querySelector('#recipe-title').innerText = ` Aprenda a fazer ${recipe.title}`;
    ...
    document.querySelector('#recipe-difficulty').innerText = ` ${recipe.difficulty}`;
    ...
    document.querySelector("#recipe-instructions").innerText = recipe.instructions;
};
